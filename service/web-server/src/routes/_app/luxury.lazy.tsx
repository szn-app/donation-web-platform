          ...
          <div className="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
            <div className="xl:aspect-auto relative aspect-[2/1] h-full animate-appearance-in md:-mx-8 xl:mx-0">
              <img
                alt=""
                src="/image-6.png"
                className="absolute inset-0 h-full rounded-2xl bg-gray-800 object-cover shadow-2xl md:w-full xl:w-1/2"
              />
            </div>
          </div>
          <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
            <figure className="relative isolate pt-6 sm:pt-12">
              ...
              <figcaption className="mt-8 text-base">
                <div className="font-semibold text-white">- Mr & Mrs</div>
                <div className="mt-1 text-right text-gray-200">
                  coming soon...
                </div>
              </figcaption>
            </figure>
